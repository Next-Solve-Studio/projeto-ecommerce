...
import { ShoppingCart, Search, User, ChevronDown, Heart, HeadphonesIcon } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between gap-4 md:gap-6">
          <Link href="/" className="shrink-0 flex items-center">
            <Image src={logoImg} alt="ElectronicSolve Store" width={120} height={40} className="h-10 object-contain" />
          </Link>

          <div className="flex-1 max-w-2xl hidden md:block relative" ref={suggestionRef}>
              ...
              <div className="absolute top-full mt-1 w-full bg-white border border-gray-200 rounded-md shadow-lg overflow-hidden z-50">
                {filteredCategories.length > 0 && (
                  <div className="border-b border-gray-100 last:border-0">
                    <div className="px-3 py-2 bg-gray-50 text-xs font-semibold text-gray-500 uppercase">Categorias</div>
                    <ul>
                ...
                {filteredProducts.length > 0 && (
                  <div className="border-b border-gray-100 last:border-0">
                    <div className="px-3 py-2 bg-gray-50 text-xs font-semibold text-gray-500 uppercase">Produtos</div>
                    <ul>
          ...
          <div className="flex items-center gap-1 md:gap-3 shrink-0">
            ...
            >
              ...
              <span className="hidden lg:inline text-sm font-medium">Carrinho</span>
              {itemCount > 0 && (
