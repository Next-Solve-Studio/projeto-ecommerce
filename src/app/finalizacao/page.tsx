    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-4 max-w-3xl">
        <div className="bg-white p-8 md:p-12 rounded-lg border shadow-sm text-center">
          ...
          <p className="text-gray-500 mb-8">Obrigado por comprar conosco. Seu pedido foi recebido e está sendo processado.</p>

          <div className="inline-block bg-gray-50 border px-6 py-3 rounded-lg mb-8">
            <p className="text-sm text-gray-500 uppercase tracking-wide font-semibold">Número do Pedido</p>
            <p className="text-2xl font-bold font-mono text-black">#UX-12345</p>
          </div>
          ...
          <div className="text-left bg-gray-50 rounded-lg p-6 mb-8 border space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6 pt-4 border-t mt-6">
              <div>
                ...
                <div className="space-y-1 mb-4">
                  {orderItems.length > 0 ? (
                    ...
                    <p className="text-sm text-gray-600">Notebook e Smartphone (Exemplo)</p>
                  )}
                </div>
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mb-4">Rua Exemplo, 123<br/>Centro - São Paulo, SP<br/>CEP: 00000-000</p>
                ...
                {paymentMethod === 'Cartão de Crédito' && (
                  <p className="text-sm text-gray-600">{installments}x sem juros</p>
                )}
                <p className="text-sm font-bold mt-1 text-black">Total: R$ {total > 0 ? total.toLocaleString('pt-BR', { minimumFractionDigits: 2 }) : '1.299,00'}</p>
              </div>
            </div>
          </div>
