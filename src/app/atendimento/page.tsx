      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-lg border text-center hover:shadow-md transition-shadow">
            ...
            <p className="text-sm text-gray-500 mb-4">Fale com um atendente em tempo real.</p>
            <span className="text-sm font-medium text-blue-600">Disponível agora</span>
          </div>

          <div className="bg-white p-6 rounded-lg border text-center hover:shadow-md transition-shadow">
            <Phone className="mx-auto mb-4 text-green-600" size={32} />
            <h3 className="font-bold mb-2">Telefone</h3>
            <p className="text-sm text-gray-500 mb-4">Segunda a Sexta, das 8h às 18h.</p>
            <span className="text-sm font-medium text-green-600">0800 123 4567</span>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg border text-center hover:shadow-md transition-shadow">
            ...
            <span className="text-sm font-medium text-purple-600">suporte@electronicsolve.com</span>
          </div>
        </div>
      </div>
    </div>
